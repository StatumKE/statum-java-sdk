 ...
 * <h2>Main Classes</h2>
 * <ul>
 * <li>{@link co.ke.statum.sdk.StatumClient} - Main entry point</li>
 * <li>{@link co.ke.statum.sdk.config.StatumConfig} - Configuration</li>
 * <li>{@link co.ke.statum.sdk.services.AirtimeService} - Airtime
 * operations</li>
 * <li>{@link co.ke.statum.sdk.services.SmsService} - SMS operations</li>
 * <li>{@link co.ke.statum.sdk.services.AccountService} - Account
 * operations</li>
 * </ul>
 *
 * @since 1.0.0
